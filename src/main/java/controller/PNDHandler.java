...
//                "    </header>\n" +
//                "    <section>\n" +
//                "        <button class=\"btn btn-update\" onclick=\"getPND()\">Обновить список</button>\n" +
//                "        <div id=\"PND\"></div>\n" +
//                "    </section>\n" +
//                "    <hr>\n" +
//                "</article>\n" +
...
//                "</html>";
//
//        ByteArrayInputStream inputStream = new ByteArrayInputStream(getText().getBytes(StandardCharsets.UTF_8));
//        NanoHTTPD.Response r = newFixedLengthResponse(NanoHTTPD.Response.Status.OK, "text/html", body);
//        //r.setData(inputStream);
//        return r;
//    }
//
//    @Override
...
//    }
    ...
    public String getText() {
        String body = "<!DOCTYPE html>\n" +
                ...
                "    </header>\n" +
                "    <section>\n" +
                "        <button class=\"btn btn-update\" onclick=\"getPND()\">Обновить список</button> Для сортировки по колонке нажмите на неё.  Для поиска по ключевому слову <b>Ctrl + F</b>\n" +
                "        <div id=\"PND\"></div>\n" +
                "    </section>\n" +
                "    <hr>\n" +
                "</article>\n" +
